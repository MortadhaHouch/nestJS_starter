...
__decorate([
    (0, class_validator_1.IsString)({ message: "Name must be a valid" }),
    (0, class_validator_1.MinLength)(3, { message: "Name must be at least 3 characters long" }),
    __metadata("design:type", String)
], CreateTeamDto.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsString)({ message: "Description must be a valid" }),
    (0, class_validator_1.MinLength)(3, { message: "Description must be at least 3 characters long" }),
    __metadata("design:type", String)
