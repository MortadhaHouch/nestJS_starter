...
export default function WaitlistPage() {
  ...
  return (
    <main className="flex overflow-hidden relative justify-center items-center w-full min-h-screen xl:h-screen">
      <Spotlight />
      ...
      <div className="relative z-[100] mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        <motion.div
          ...
          className="inline-flex gap-2 items-center px-4 py-2 mb-8 bg-gradient-to-r rounded-full border backdrop-blur-sm border-primary/10 from-primary/15 to-primary/5"
        >
          <img
        ...
        <motion.h1
          ...
          className={cn(
            'mb-4 text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-b cursor-crosshair from-foreground via-foreground/80 to-foreground/40 sm:text-7xl',
          )}
        >
          Join the{' '}
          <span className="text-transparent bg-clip-text via-rose-300 bg-primary from-foreground to-primary dark:bg-gradient-to-b">
            Waitlist
          </span>
        </motion.h1>
        ...
        <motion.div
          ...
          className="grid grid-cols-2 gap-6 mb-12 sm:grid-cols-3"
        >
          <div
            className={cn(
        ...
        <motion.form
          ...
          className="flex flex-col gap-4 mx-auto sm:flex-row"
        >
              ...
              <>
                <div className="relative flex-1">
                  <motion.input
                    ...
                    required
                    className="px-6 py-4 w-full rounded-xl border backdrop-blur-md transition-all border-primary/20 bg-white/5 text-foreground placeholder:text-muted-foreground/70 focus:border-primary/50 focus:outline-none focus:ring-2 focus:ring-primary/30"
                  />
                  {error && (
                    <motion.p
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
                      className="px-4 py-1 mt-2 text-sm rounded-xl border border-destructive/40 bg-destructive/10 text-destructive sm:absolute"
                    >
                      {error}
                    </motion.p>
                  )}
                ...
                >
                  ...
                  <span className="absolute inset-0 z-0 bg-gradient-to-r from-rose-500 opacity-0 transition-opacity duration-300 to-primary group-hover:opacity-100"></span>
                </button>
              </>
            ) : (
              <motion.div
        ...
        <motion.div
          ...
          className="flex gap-1 justify-center items-center mt-10"
        >
