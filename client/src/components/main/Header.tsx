...
export default function Header() {
  return (
    <NavigationMenu className="bg-background border-b border-border shadow-sm dark:border-border/50 dark:bg-background/95 dark:backdrop-blur-sm data-[state=open]:bg-background/95 data-[state=open]:backdrop-blur-sm data-[state=open]:border-background/10 w-screen flex flex-row items-center justify-between">
      <NavigationMenuList className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        <NavigationMenuItem>
