...
export function TestimonialCard({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="text-sm font-normal select-none text-muted-foreground">
        {description}
      ...
      <div className="flex gap-5 justify-start items-center w-full select-none">
        <img
          width={40}
          height={40}
          src={img || ''}
          alt={name}
          className="rounded-full ring-1 ring-offset-2 size-10 ring-blue-500/20"
        />
...
export default function Testimonials() {
  return (
    <section className="container relative py-10">
      {/* Decorative elements */}
      <div className="absolute top-20 -left-20 z-10 w-64 h-64 rounded-full blur-3xl bg-blue-500/5" />
      <div className="absolute -right-20 bottom-20 z-10 w-64 h-64 rounded-full blur-3xl bg-blue-500/5" />
      ...
      >
        ...
        <h3 className="mx-auto mb-8 max-w-lg text-lg font-medium tracking-tight text-center text-balance text-muted-foreground">
      ...
      <div className="overflow-hidden relative mt-6 max-h-screen">
